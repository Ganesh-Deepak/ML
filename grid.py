...
if (accuracy1>0.99) :
	joblib.dump(model, 'svm_final_model.pkl')
	break
''' 
...
svm_from_joblib = joblib.load('svm_final_model.pkl')
...
# defining parameter range
param_grid = {  'bootstrap': [True], 'max_depth': [5,6,7,8,9,10], 'max_features': ['auto', 'log2'], 'n_estimators': [100,200,300,400,500]}
...
'''
from sklearn.ensemble import RandomForestClassifier
rfc_model=RandomForestClassifier(bootstrap= True, max_depth= 10, max_features= 'auto', n_estimators= 400)
